...
namespace pel {
	...
	namespace groups {
		...
		{
			object_t() = default;
			object_t(const std::string& str) { data = str; }
			object_t(const std::string& str, std::size_t nl, std::size_t sp, std::size_t ep) { data = str; number_line = nl; start_position = sp;  end_position = ep; }
			object_t(const std::string& str, std::size_t nl, std::size_t sp, std::size_t ep, group_t* g) { data = str; number_line = nl; start_position = sp;  end_position = ep; group = g; }
		...
		class position_element_t
		{
			public:
				...
				position_element_t() = default;
				position_element_t(std::initializer_list<object_t> objects) : words(objects.begin(), objects.end()) {
		...
		{
			public:
				array_words_t() = default;
			//	array_words_t(std::initializer_list<position_element_t> position_element) : data(position_element.begin(), position_element.end()) {}

				array_words_t(std::initializer_list<object_t> objects) {
